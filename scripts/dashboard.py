...
def build_trading_dashboard(metrics: List[Metric], signals: List[DerivedSignal]) -> Dict[str, Any]:
    ...
    return {
        "core": compact([
            signal_item("SOFR_ANCHOR", "CORE", "回购融资是否高于政策锚"),
            signal_item("SOFR_VOLUME_IMPACT", "CORE", "SOFR价格偏离作用在多大交易量上"),
            metric_item("TGA", "CORE", "财政抽水/放水"),
            signal_item("RRP_FLOW", "CORE", "RRP边际流量方向"),
            signal_item("RRP_BUFFER", "CORE", "非银现金缓冲垫厚度"),
            metric_item("WRESBAL", "CORE", "银行准备金水位"),
            signal_item("UST_1Y_YIELD", "CORE", "短债近端政策路径"),
            signal_item("UST_3Y_YIELD", "CORE", "中段政策路径再定价"),
            signal_item("UST_5Y_YIELD", "CORE", "腹部5年期再定价"),
            signal_item("UST_7Y_YIELD", "CORE", "腹部7年期再定价"),
            signal_item("HY_CHANGE", "CORE", "信用压力是否扩散"),
        ]),
        "confirm": compact([
            metric_item("OBFR", "CONFIRM", "银行融资压力是否扩散"),
            metric_item("TGCR", "CONFIRM", "三方回购融资确认"),
            metric_item("BGCR", "CONFIRM", "广义回购融资确认"),
            signal_item("BGCR_TGCR", "CONFIRM", "回购内部结构扰动"),
            signal_item("IG_CHANGE", "CONFIRM", "投资级信用融资"),
            signal_item("VIX_RISK", "CONFIRM", "证券市场波动率水平"),
            signal_item("VIX_MOMENTUM", "CONFIRM", "证券市场风险偏好边际变化"),
            metric_item("SOFR_VOLUME", "CONFIRM", "回购融资交易量级"),
            signal_item("TBILL_AUCTION_STRESS", "CONFIRM", "T-bill供给×需求吸收压力"),
            metric_item("TBILL_AUCTION_BTC", "CONFIRM", "短债拍卖需求强度"),
            metric_item("UST_AUCTION_BTC", "CONFIRM", "国债供给吸收能力"),
        ...
        "background": compact([
            ...
            signal_item("UST_10Y_NOMINAL_LEVEL", "BACKGROUND", "10Y名义收益率水平背景"),
