window.DASHBOARD_DATA = {
  "meta": {
    "title": "美元流动性监测",
    "trigger": "更新数据并分析",
    "generated_at_bjt": "2026-07-14 20:21:40 UTC+08:00",
  ...
  "status_scale": {
    ...
    "score_from_rule": 1.5999999999999999
  },
  "trading_dashboard": {
    "core": [
      {
      ...
      },
      {
        ...
        "priority": "P0",
        "value_text": "-4.3mn/day",
        "previous_text": "-8.5mn/day",
        "change_text": "+4.2mn/day",
        "severity": "中性",
        "why": "SOFR价格偏离作用在多大交易量上",
        "interpretation": "SOFR交易量约3,096bn，但SOFR相对政策锚偏离有限，价格×规模冲击不大。",
        "as_of": "2026-07-13",
    ...
    "confirm": [
      ...
      },
      {
        ...
        "priority": "P2",
        "value_text": "3,096.0bn",
        "previous_text": "3,056.0bn",
        "change_text": "+40.0bn",
        "severity": "中性",
        "why": "回购融资交易量级",
      ...
      },
      {
        ...
        "severity": "中性",
        "why": "T-bill供给×需求吸收压力",
        "interpretation": "最新T-bill拍卖规模约195.0bn，认购倍数2.79x，上一T-bill拍卖日认购倍数 3.41x；该分数综合供给规模与需求覆盖，数值越高表示吸收压力越大。供给吸收处于中性区间。",
        "as_of": "2026-07-09",
    ...
    "background": [
      ...
      },
      {
        ...
        "severity": "偏紧",
        "why": "10Y名义收益率边际",
        "interpretation": "长期名义折现率上行，债券久期和股票估值承压",
        "as_of": "2026-07-13",
        "frequency": "日频，FRED/H.15国债恒定期限收益率"
      },
      {
  ...
  "upcoming_auctions": {
    ...
    "as_of": "2026-07-14",
    "lookforward_days": 60,
    "source_url": "https://www.treasurydirect.gov/TA_WS/securities/search?format=json&startDate=2026-07-14&endDate=2026-09-12",
    "auctions": [
      {
  ...
  "jpy_carry": {
    "meta": {
      "generated_at_bjt": "2026-07-14 20:21:16 UTC+08:00",
    ...
    },
    {
      ...
      "indicators": [
        ...
        },
        {
          ...
          "interpretation_hint": "",
          "source": "NY Fed Markets API",
          "source_url": "https://markets.newyorkfed.org/api/rp/reverserepo/propositions/search.json?startDate=2026-06-30&endDate=2026-07-14",
          "status": "ok",
    ...
    },
    {
      ...
      "indicators": [
        ...
        },
        {
          ...
          "source_url": "https://www.treasurydirect.gov/TA_WS/securities/search?format=json&startDate=2026-06-23&endDate=2026-07-14",
          "status": "ok",
  ...
  "derived_signals": [
    ...
    },
    {
      "id": "SOFR_VOLUME_IMPACT",
      "label": "SOFR Rate-Volume Impact（SOFR价格×交易量影响）",
      "value": -4.299999999999985,
      "value_text": "-4.3mn/day",
      "previous": -8.488888888888896,
      "previous_text": "-8.5mn/day",
      "change": 4.188888888888911,
      "change_text": "+4.2mn/day",
      "unit": "USD mn/day",
      "severity": "中性",
      "meaning": "SOFR交易量约3,096bn，但SOFR相对政策锚偏离有限，价格×规模冲击不大。",
      "as_of": "2026-07-13"
    },
    {
      "id": "BGCR_TGCR",
    ...
    },
    {
      ...
      "value": -6.363999999999919,
      "value_text": "-6.36bn",
      "previous": -4.607000000000085,
      "previous_text": "-4.61bn",
      "change": -1.7569999999998345,
      "change_text": "-1.8bn",
      "unit": "bn",
      "severity": "中性",
      "meaning": "财政资金流变化不大",
    ...
    },
    {
      ...
      "value_text": "36.0bp",
      "previous": 34.999999999999964,
      "previous_text": "35.0bp",
      "change": 1.000000000000064,
      "change_text": "+1.0bp",
      "unit": "bp",
      "severity": "中性",
    ...
    },
    {
      ...
      "unit": "index",
      "severity": "中性",
      "meaning": "最新T-bill拍卖规模约195.0bn，认购倍数2.79x，上一T-bill拍卖日认购倍数 3.41x；该分数综合供给规模与需求覆盖，数值越高表示吸收压力越大。供给吸收处于中性区间。",
      "as_of": "2026-07-09"
    },
    {
      "id": "AUCTION_BTC",
  ...
  "chart_paths": [
    "/Users/eiheisun/WorkBuddy/2026-05-04-task-1/output/usd_liquidity_chart_7d_20260714_202116.svg",
    "/Users/eiheisun/WorkBuddy/2026-05-04-task-1/output/usd_liquidity_chart_30d_20260714_202116.svg"
  ],
  "data_quality": {
    "missing": [],
    "stale": [
