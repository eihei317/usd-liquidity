window.DASHBOARD_DATA = {
  ...
  "trading_dashboard": {
    "core": [
      ...
      },
      {
        ...
        "previous_text": "-2.5mn/day",
        "change_text": "+1.7mn/day",
        "severity": "中性",
        "why": "SOFR价格偏离作用在多大交易量上",
        "interpretation": "SOFR交易量约2,971bn，但SOFR相对政策锚偏离有限，价格×规模冲击不大。",
        "as_of": "2026-07-23",
    ...
    "confirm": [
      ...
      },
      {
        ...
        "priority": "CONFIRM",
        "value_text": "2,971.0bn",
        "previous_text": "3,026.0bn",
        "change_text": "-55.0bn",
        "severity": "中性",
        "why": "回购融资交易量级",
      ...
      },
      {
        ...
        "severity": "中性",
        "why": "T-bill供给×需求吸收压力",
        "interpretation": "最新T-bill拍卖规模约95.0bn，认购倍数2.79x，上一T-bill拍卖日认购倍数 2.97x；该分数综合供给规模与需求覆盖，数值越高表示吸收压力越大。供给吸收处于中性区间。",
        "as_of": "2026-07-21",
      ...
      },
      {
        ...
        "severity": "偏松",
        "why": "5Y通胀补偿，不等同纯通胀预期",
        "interpretation": "5Y通胀补偿显著回落，名义收益率中的通胀补偿压力缓和；该指标不是纯通胀预期。",
        "as_of": "2026-07-24",
        "frequency": "日频，FRED/H.15国债恒定期限收益率"
      },
      {
  ...
  "upcoming_auctions": {
    ...
    "as_of": "2026-07-26",
    "lookforward_days": 60,
    "source_url": "https://www.treasurydirect.gov/TA_WS/securities/search?format=json&startDate=2026-07-26&endDate=2026-09-24",
    "auctions": [
      {
    ...
    },
    {
      ...
      "indicators": [
        ...
        },
        {
          ...
          "interpretation_hint": "",
          "source": "NY Fed Markets API",
          "source_url": "https://markets.newyorkfed.org/api/rp/reverserepo/propositions/search.json?startDate=2026-07-12&endDate=2026-07-26",
          "status": "ok",
        ...
        },
        {
          ...
          "label": "SOMA（系统公开市场账户持仓）",
          "category": "Fed负债端",
          "value": 6356.127853425201,
          "value_text": "6,356.1bn",
          "unit": "USD bn",
          "previous": 6354.496725040401,
          "change": 1.631128384799922,
          "change_text": "+1.6bn",
          "change_direction": "up",
          "as_of": "2026-07-22",
    ...
    },
    {
      ...
      "indicators": [
        ...
        },
        {
          ...
          "source_url": "https://www.treasurydirect.gov/TA_WS/securities/search?format=json&startDate=2026-07-05&endDate=2026-07-26",
          "status": "ok",
        ...
        },
        {
          ...
          "value_text": "2.79x",
          "unit": "ratio",
          "previous": 2.9722807017543857,
          "change": -0.1822807017543857,
          "change_text": "-0.18x",
          "change_direction": "down",
          "as_of": "2026-07-21",
          "previous_as_of": "2026-07-20",
      ...
      "indicators": [
        {
          ...
          "unit": "index",
          "previous": 120.331,
          "change": 0.20049999999999102,
          "change_text": "+0.20",
          "change_direction": "up",
          "as_of": "2026-07-17",
          "previous_as_of": "2026-07-16",
  ...
  "derived_signals": [
    ...
    },
    {
      "id": "SOFR_VOLUME_IMPACT",
      "label": "SOFR Rate-Volume Impact（SOFR价格×交易量影响）",
      "value": -0.8252777777777603,
      "value_text": "-0.8mn/day",
      "previous": -2.52166666666665,
      "previous_text": "-2.5mn/day",
      "change": 1.6963888888888898,
      "change_text": "+1.7mn/day",
      "unit": "USD mn/day",
      "severity": "中性",
      "meaning": "SOFR交易量约2,971bn，但SOFR相对政策锚偏离有限，价格×规模冲击不大。",
      "as_of": "2026-07-23"
    },
    {
      "id": "BGCR_TGCR",
    ...
    },
    {
      ...
      "value": 41.78399999999999,
      "value_text": "41.78bn",
      "previous": -39.56299999999999,
      "previous_text": "-39.56bn",
      "change": 81.34699999999998,
      "change_text": "+81.3bn",
      "unit": "bn",
      "severity": "中性",
      "meaning": "财政资金流变化不大",
    ...
    },
    {
      ...
      "value": -2.75000000000003,
      "value_text": "-2.75bp avg",
      "previous": null,
      "previous_text": "NA",
      "change": null,
      "change_text": "NA",
    ...
    },
    {
      ...
      "unit": "%",
      "severity": "偏松",
      "meaning": "5Y通胀补偿显著回落，名义收益率中的通胀补偿压力缓和；该指标不是纯通胀预期。",
      "as_of": "2026-07-24"
    },
    {
    ...
    },
    {
      "id": "UST_10Y2Y",
      "label": "10Y-2Y Treasury Spread（10年-2年美债利差）",
      "value": 36.00000000000003,
      "value_text": "36.0bp",
      "previous": 33.999999999999986,
      "previous_text": "34.0bp",
    ...
    },
    {
      "id": "UST_10Y3M",
      "label": "10Y-3M Treasury Spread（10年-3个月美债利差）",
      "value": 73.00000000000004,
      "value_text": "73.0bp",
      "previous": 75.99999999999997,
      "previous_text": "76.0bp",
      "change": -2.999999999999929,
      "change_text": "-3.0bp",
      "unit": "bp",
      "severity": "中性",
    ...
    },
    {
      ...
      "unit": "index",
      "severity": "中性",
      "meaning": "最新T-bill拍卖规模约95.0bn，认购倍数2.79x，上一T-bill拍卖日认购倍数 2.97x；该分数综合供给规模与需求覆盖，数值越高表示吸收压力越大。供给吸收处于中性区间。",
      "as_of": "2026-07-21"
    },
    {
      "id": "AUCTION_BTC",
